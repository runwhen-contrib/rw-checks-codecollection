...
def actionlint(ctx: Context, tree: Path, changed: list[str] | None = None):
    ...
    return {"findings": ctx.findings.cap(tools.actionlint.check(ctx, tree, changed))}
